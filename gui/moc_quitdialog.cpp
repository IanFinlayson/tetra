...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QuitDialog_t, stringdata) + ofs \
...
const QMetaObject QuitDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_QuitDialog.data,
      qt_meta_data_QuitDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QuitDialog.stringdata))
