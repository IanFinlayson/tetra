...
class ComparisonList
{
	public:
		...
		bool execute(NodeKind n, const Node* a, const Node* b, TetraContext& context) {
	...
	private:
		...
		std::map<NodeKind, bool (ComparisonList<T>::*)(const Node*,const Node*,TetraContext&)> compMap;
