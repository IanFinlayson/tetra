...
NodeTable::NodeTable() {
	...
	nodeChart[NODE_BREAK] = FLAG;
	nodeChart[NODE_CONTINUE] = FLAG;
	nodeChart[NODE_RETURN] = FLAG;
	...
	nodeChart[NODE_PARFOR] = PARALLEL;
	nodeChart[NODE_PARALLEL] = PARALLEL;
	nodeChart[NODE_BACKGROUND] = PARALLEL;
	nodeChart[NODE_LOCK] = PARALLEL;
